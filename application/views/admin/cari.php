          ...
          <div class="row item ">
            <div class="col-md-4">
              ...
              <?php 
               ...
               ?>
              <form action="<?= site_url().'Admin/updateItem'?>" method = "POST" enctype="multipart/form-data">
              
                <input type="hidden" value ="<?= $key['item_id']?>" name = "id">
                <input type="file" name="image" id="fileToUpload">
                <textarea class="update foto">
                  <img src="<?= base_url().'assets/uploadfile/'.$key['image']?>" alt="gambar" style = "width: 100px" >
            ...
            <div class="col-md-4 ">
              <div class="kedua">
                <div class="form-group item">
                  ...
                  <input class="form-control" name = "item_name" id="exampleInputEmail1" value = "<?= $key['item_name']?>">
                </div>
                <div class="form-group item">
                  <label for="exampleInputPassword1">Item Category</label>
                  <input class="form-control" name = "category" id="exampleInputPassword1" value = "<?= $key['category']?>">
                </div>
                <div class="form-group item">
                  <label for="exampleInputPassword1">Item Price</label>
                  <input class="form-control" name = "price" id="exampleInputPassword1" value = "<?= $key['price']?>">
                </div>
            ...
            <div class="col-md-4 ketiga">
              <div class="ketiga">
                <div class="form-group item">
                  ...
                  <textarea name = "spesification"><?= $key['spesification']?></textarea>
                </div>
                <div class="form-group item">
                  <label for="exampleInputPassword1">Item Quanity</label>
                  <input class="form-control" name = "stock" id="exampleInputPassword1" value = "<?= $key['stock']?>">
                </div>
                </form>
                <a href="<?= site_url().'Admin/deleteItem/'.$key['item_id'].'/delete'?>"><button type="submit" class="btn delete" name = "delete">Delete</button></a>
