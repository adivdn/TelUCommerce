                        ...
                        <div class="card satu">
                            <div class="card-body">
                                ...
                                <div class="row biodata_input">
                                    <div class="col-md-12">
                                        <form action="<?= site_url().'User/resetPassword'?>" method="POST" id="form1">
                                            ...
                                            <div class="form-group row">
                                                <label for="re_password" class="col-4 col-form-label">New Password</label>
                                                <div class="col-8">
                                                    <input id="re_password" name="re_password"
                                                        class="form-control here" required="required" type="password">
                                                </div>
                                                <small class="form-text text-danger"><?= form_error('re_password') ?></small>
                                            </div>
                                            <div class="form-group row">
                                                <label for="co-password" class="col-4 col-form-label">Confirm Password</label>
                                                <div class="col-8">
                                                    <input id="co_password" name="co_password"
                                                    class="form-control here" required="required" type="password">
                                                </div>
                                                <small class="form-text text-danger"><?= form_error('co_password') ?></small>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <button class="btn btn-success" name="reset"
                                                    style="margin-left: 29px;">Change my password</button>
                                            </div>
                                        </div>
